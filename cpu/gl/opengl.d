...
extern(C) void /*APIENTRY*/glAlphaFunc (GLenum func, GLclampf ref_);
extern(C) GLboolean /*APIENTRY*/glAreTexturesResident (GLsizei n, GLuint *textures, GLboolean *residences);
...
extern(C) void /*APIENTRY*/glBitmap (GLsizei width, GLsizei height, GLfloat xorig, GLfloat yorig, GLfloat xmove, GLfloat ymove, GLubyte *bitmap);
extern(C) void /*APIENTRY*/glBlendFunc (GLenum sfactor, GLenum dfactor);
extern(C) void /*APIENTRY*/glCallList (GLuint list);
extern(C) void /*APIENTRY*/glCallLists (GLsizei n, GLenum type, GLvoid *lists);
...
extern(C) void /*APIENTRY*/glColorPointer (GLint size, GLenum type, GLsizei stride, GLvoid *pointer);
...
extern(C) void /*APIENTRY*/glDeleteTextures (GLsizei n, GLuint *textures);
...
extern(C) void /*APIENTRY*/glDrawElements (GLenum mode, GLsizei count, GLenum type, GLvoid *indices);
extern(C) void /*APIENTRY*/glDrawPixels (GLsizei width, GLsizei height, GLenum format, GLenum type, GLvoid *pixels);
extern(C) void /*APIENTRY*/glEdgeFlag (GLboolean flag);
extern(C) void /*APIENTRY*/glEdgeFlagPointer (GLsizei stride, GLvoid *pointer);
extern(C) void /*APIENTRY*/glEdgeFlagv (GLboolean *flag);
...
extern(C) void /*APIENTRY*/glEvalCoord1dv (GLdouble *u);
extern(C) void /*APIENTRY*/glEvalCoord1f (GLfloat u);
extern(C) void /*APIENTRY*/glEvalCoord1fv (GLfloat *u);
extern(C) void /*APIENTRY*/glEvalCoord2d (GLdouble u, GLdouble v);
extern(C) void /*APIENTRY*/glEvalCoord2dv (GLdouble *u);
extern(C) void /*APIENTRY*/glEvalCoord2f (GLfloat u, GLfloat v);
extern(C) void /*APIENTRY*/glEvalCoord2fv (GLfloat *u);
...
extern(C) void /*APIENTRY*/glFogfv (GLenum pname, GLfloat *params);
extern(C) void /*APIENTRY*/glFogi (GLenum pname, GLint param);
extern(C) void /*APIENTRY*/glFogiv (GLenum pname, GLint *params);
...
extern(C) GLubyte * /*APIENTRY*/glGetString (GLenum name);
...
extern(C) void /*APIENTRY*/glIndexPointer (GLenum type, GLsizei stride, GLvoid *pointer);
extern(C) void /*APIENTRY*/glIndexd (GLdouble c);
extern(C) void /*APIENTRY*/glIndexdv (GLdouble *c);
extern(C) void /*APIENTRY*/glIndexf (GLfloat c);
extern(C) void /*APIENTRY*/glIndexfv (GLfloat *c);
extern(C) void /*APIENTRY*/glIndexi (GLint c);
extern(C) void /*APIENTRY*/glIndexiv (GLint *c);
extern(C) void /*APIENTRY*/glIndexs (GLshort c);
extern(C) void /*APIENTRY*/glIndexsv (GLshort *c);
extern(C) void /*APIENTRY*/glIndexub (GLubyte c);
extern(C) void /*APIENTRY*/glIndexubv (GLubyte *c);
extern(C) void /*APIENTRY*/glInitNames ();
extern(C) void /*APIENTRY*/glInterleavedArrays (GLenum format, GLsizei stride, GLvoid *pointer);
...
extern(C) void /*APIENTRY*/glLightModelfv (GLenum pname, GLfloat *params);
extern(C) void /*APIENTRY*/glLightModeli (GLenum pname, GLint param);
extern(C) void /*APIENTRY*/glLightModeliv (GLenum pname, GLint *params);
extern(C) void /*APIENTRY*/glLightf (GLenum light, GLenum pname, GLfloat param);
extern(C) void /*APIENTRY*/glLightfv (GLenum light, GLenum pname, GLfloat *params);
extern(C) void /*APIENTRY*/glLighti (GLenum light, GLenum pname, GLint param);
extern(C) void /*APIENTRY*/glLightiv (GLenum light, GLenum pname, GLint *params);
...
extern(C) void /*APIENTRY*/glLoadMatrixd (GLdouble *m);
extern(C) void /*APIENTRY*/glLoadMatrixf (GLfloat *m);
extern(C) void /*APIENTRY*/glLoadName (GLuint name);
extern(C) void /*APIENTRY*/glLogicOp (GLenum opcode);
extern(C) void /*APIENTRY*/glMap1d (GLenum target, GLdouble u1, GLdouble u2, GLint stride, GLint order, GLdouble *points);
extern(C) void /*APIENTRY*/glMap1f (GLenum target, GLfloat u1, GLfloat u2, GLint stride, GLint order, GLfloat *points);
extern(C) void /*APIENTRY*/glMap2d (GLenum target, GLdouble u1, GLdouble u2, GLint ustride, GLint uorder, GLdouble v1, GLdouble v2, GLint vstride, GLint vorder, GLdouble *points);
extern(C) void /*APIENTRY*/glMap2f (GLenum target, GLfloat u1, GLfloat u2, GLint ustride, GLint uorder, GLfloat v1, GLfloat v2, GLint vstride, GLint vorder, GLfloat *points);
...
extern(C) void /*APIENTRY*/glMaterialfv (GLenum face, GLenum pname, GLfloat *params);
extern(C) void /*APIENTRY*/glMateriali (GLenum face, GLenum pname, GLint param);
extern(C) void /*APIENTRY*/glMaterialiv (GLenum face, GLenum pname, GLint *params);
extern(C) void /*APIENTRY*/glMatrixMode (GLenum mode);
extern(C) void /*APIENTRY*/glMultMatrixd (GLdouble *m);
extern(C) void /*APIENTRY*/glMultMatrixf (GLfloat *m);
extern(C) void /*APIENTRY*/glNewList (GLuint list, GLenum mode);
extern(C) void /*APIENTRY*/glNormal3b (GLbyte nx, GLbyte ny, GLbyte nz);
extern(C) void /*APIENTRY*/glNormal3bv (GLbyte *v);
extern(C) void /*APIENTRY*/glNormal3d (GLdouble nx, GLdouble ny, GLdouble nz);
extern(C) void /*APIENTRY*/glNormal3dv (GLdouble *v);
extern(C) void /*APIENTRY*/glNormal3f (GLfloat nx, GLfloat ny, GLfloat nz);
extern(C) void /*APIENTRY*/glNormal3fv (GLfloat *v);
extern(C) void /*APIENTRY*/glNormal3i (GLint nx, GLint ny, GLint nz);
extern(C) void /*APIENTRY*/glNormal3iv (GLint *v);
extern(C) void /*APIENTRY*/glNormal3s (GLshort nx, GLshort ny, GLshort nz);
extern(C) void /*APIENTRY*/glNormal3sv (GLshort *v);
extern(C) void /*APIENTRY*/glNormalPointer (GLenum type, GLsizei stride, GLvoid *pointer);
...
extern(C) void /*APIENTRY*/glPixelMapfv (GLenum map, GLsizei mapsize, GLfloat *values);
extern(C) void /*APIENTRY*/glPixelMapuiv (GLenum map, GLsizei mapsize, GLuint *values);
extern(C) void /*APIENTRY*/glPixelMapusv (GLenum map, GLsizei mapsize, GLushort *values);
...
extern(C) void /*APIENTRY*/glPolygonStipple (GLubyte *mask);
...
extern(C) void /*APIENTRY*/glPrioritizeTextures (GLsizei n, GLuint *textures, GLclampf *priorities);
...
extern(C) void /*APIENTRY*/glStencilFunc (GLenum func, GLint ref_, GLuint mask);
...
extern(C) void /*APIENTRY*/glTexCoord1dv (GLdouble *v);
extern(C) void /*APIENTRY*/glTexCoord1f (GLfloat s);
extern(C) void /*APIENTRY*/glTexCoord1fv (GLfloat *v);
extern(C) void /*APIENTRY*/glTexCoord1i (GLint s);
extern(C) void /*APIENTRY*/glTexCoord1iv (GLint *v);
extern(C) void /*APIENTRY*/glTexCoord1s (GLshort s);
extern(C) void /*APIENTRY*/glTexCoord1sv (GLshort *v);
extern(C) void /*APIENTRY*/glTexCoord2d (GLdouble s, GLdouble t);
extern(C) void /*APIENTRY*/glTexCoord2dv (GLdouble *v);
extern(C) void /*APIENTRY*/glTexCoord2f (GLfloat s, GLfloat t);
extern(C) void /*APIENTRY*/glTexCoord2fv (GLfloat *v);
extern(C) void /*APIENTRY*/glTexCoord2i (GLint s, GLint t);
extern(C) void /*APIENTRY*/glTexCoord2iv (GLint *v);
extern(C) void /*APIENTRY*/glTexCoord2s (GLshort s, GLshort t);
extern(C) void /*APIENTRY*/glTexCoord2sv (GLshort *v);
extern(C) void /*APIENTRY*/glTexCoord3d (GLdouble s, GLdouble t, GLdouble r);
extern(C) void /*APIENTRY*/glTexCoord3dv (GLdouble *v);
extern(C) void /*APIENTRY*/glTexCoord3f (GLfloat s, GLfloat t, GLfloat r);
extern(C) void /*APIENTRY*/glTexCoord3fv (GLfloat *v);
extern(C) void /*APIENTRY*/glTexCoord3i (GLint s, GLint t, GLint r);
extern(C) void /*APIENTRY*/glTexCoord3iv (GLint *v);
extern(C) void /*APIENTRY*/glTexCoord3s (GLshort s, GLshort t, GLshort r);
extern(C) void /*APIENTRY*/glTexCoord3sv (GLshort *v);
extern(C) void /*APIENTRY*/glTexCoord4d (GLdouble s, GLdouble t, GLdouble r, GLdouble q);
extern(C) void /*APIENTRY*/glTexCoord4dv (GLdouble *v);
extern(C) void /*APIENTRY*/glTexCoord4f (GLfloat s, GLfloat t, GLfloat r, GLfloat q);
extern(C) void /*APIENTRY*/glTexCoord4fv (GLfloat *v);
extern(C) void /*APIENTRY*/glTexCoord4i (GLint s, GLint t, GLint r, GLint q);
extern(C) void /*APIENTRY*/glTexCoord4iv (GLint *v);
extern(C) void /*APIENTRY*/glTexCoord4s (GLshort s, GLshort t, GLshort r, GLshort q);
extern(C) void /*APIENTRY*/glTexCoord4sv (GLshort *v);
extern(C) void /*APIENTRY*/glTexCoordPointer (GLint size, GLenum type, GLsizei stride, GLvoid *pointer);
extern(C) void /*APIENTRY*/glTexEnvf (GLenum target, GLenum pname, GLfloat param);
extern(C) void /*APIENTRY*/glTexEnvfv (GLenum target, GLenum pname, GLfloat *params);
extern(C) void /*APIENTRY*/glTexEnvi (GLenum target, GLenum pname, GLint param);
extern(C) void /*APIENTRY*/glTexEnviv (GLenum target, GLenum pname, GLint *params);
extern(C) void /*APIENTRY*/glTexGend (GLenum coord, GLenum pname, GLdouble param);
extern(C) void /*APIENTRY*/glTexGendv (GLenum coord, GLenum pname, GLdouble *params);
extern(C) void /*APIENTRY*/glTexGenf (GLenum coord, GLenum pname, GLfloat param);
extern(C) void /*APIENTRY*/glTexGenfv (GLenum coord, GLenum pname, GLfloat *params);
extern(C) void /*APIENTRY*/glTexGeni (GLenum coord, GLenum pname, GLint param);
extern(C) void /*APIENTRY*/glTexGeniv (GLenum coord, GLenum pname, GLint *params);
extern(C) void /*APIENTRY*/glTexImage1D (GLenum target, GLint level, GLint internalformat, GLsizei width, GLint border, GLenum format, GLenum type, GLvoid *pixels);
extern(C) void /*APIENTRY*/glTexImage2D (GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, GLvoid *pixels);
extern(C) void /*APIENTRY*/glTexParameterf (GLenum target, GLenum pname, GLfloat param);
extern(C) void /*APIENTRY*/glTexParameterfv (GLenum target, GLenum pname, GLfloat *params);
extern(C) void /*APIENTRY*/glTexParameteri (GLenum target, GLenum pname, GLint param);
extern(C) void /*APIENTRY*/glTexParameteriv (GLenum target, GLenum pname, GLint *params);
extern(C) void /*APIENTRY*/glTexSubImage1D (GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, GLvoid *pixels);
extern(C) void /*APIENTRY*/glTexSubImage2D (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, GLvoid *pixels);
...
*/
alias void 
    function(GLenum target, GLenum internalFormat, GLsizei width, GLenum format,
     GLenum type, GLvoid *data) PFNGLCOLORTABLEEXTPROC;
alias void 
    function(GLenum target, GLsizei start, GLsizei count, GLenum format,
     GLenum type, GLvoid *data) PFNGLCOLORSUBTABLEEXTPROC;
alias void 
    function(GLenum target, GLenum format, GLenum type, GLvoid *data) PFNGLGETCOLORTABLEEXTPROC;
alias void 
    function(GLenum target, GLenum pname, GLint *params) PFNGLGETCOLORTABLEPARAMETERIVEXTPROC;
alias void 
    function(GLenum target, GLenum pname, GLfloat *params) PFNGLGETCOLORTABLEPARAMETERFVEXTPROC;
